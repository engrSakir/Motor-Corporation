    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <form action="{{ route('backend.bookingPurpose.store') }}" method="POST" class="form-horizontal form-material" enctype="multipart/form-data">
                    @csrf
                    <div class="form-body">
                        <div class="card-body">
                            <div class="row pt-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label" for="category_name">Booking Name<b class="text-danger">*</b> </label>
                                        <input type="text" id="booking_name" name="booking_name" class="form-control" placeholder="Name" value="{{ old('booking_name') }}" required>
                                        @error('booking_name')
