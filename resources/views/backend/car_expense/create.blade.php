        ...
        <div class="col-md-7 align-self-center text-end">
            <div class="d-flex justify-content-end align-items-center">
                ...
                <a href="{{ route('backend.purchaseOrder.index') }}" class="btn btn-info d-none d-lg-block m-l-15"><i
                    class="fa fa-plus-circle"></i> Generate PO</a>
            </div>
        </div>
    </div>
                            ...
                            <div class="row pt-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group has-danger">
                                        ...
                                        <input type="number" step="any" id="amount" name="amount" class="form-control form-control-danger" placeholder="Amount" value="{{ old('amount') }}" required>
                                        @error('amount')
                                        <div class="alert alert-danger" role="alert">
                                            {{ $message }}
                                        </div>
