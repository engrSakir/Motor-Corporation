                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12">
                                            <h3>{{ round($investment->percentageOfSettlement(), 2) }}%
                                            </h3>
                                        ...
                                        <div class="col-12">
                                            <div class="progress">
                                                <div class="progress-bar bg-success" role="progressbar"
                                                    style="width: {{ round($investment->percentageOfSettlement(), 2) }}%; height: 6px;"
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12">
                                            <h3>{{ round($investment->percentageOfUsed(), 2) }}%
                                            </h3>
                                        ...
                                        <div class="col-12">
                                            <div class="progress">
                                                <div class="progress-bar bg-danger" role="progressbar"
                                                    style="width: {{ round($investment->percentageOfUsed(), 2) }}%; height: 6px;"
                                                    aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <form action="{{ route('backend.settlement.store') }}" method="POST"
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="any" step="any" class="form-control" name="settlemen_amount" placeholder="Settlement amount" required>
