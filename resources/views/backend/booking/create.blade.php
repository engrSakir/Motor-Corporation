                    ...
                    <div class="col-md-6">
                        <div class="form-group" style="margin-left:10px;">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" @if($booking->status == 'waiting' ) {{
                                checked}} @endif name="status" value="waiting"
                                id="status1">
                            ...
                            <div class="form-check">
                                ...
                                <input class="form-check-input" type="radio" name="status" value="done" id="status4">
