...
<div class="form-check">
                                            ...
                                            <input class="form-check-input" type="radio" @if($booking->status == 'accepted' ) checked @endif name="status" value="accepted"
                                            id="status2">
                                    ...
                                    <div class="form-check">
                                            ...
                                            <input class="form-check-input" type="radio" name="status" @if($booking->status == 'rejected' )  checked  @endif value="rejected"
                                            id="status3">
                                    ...
                                    <div class="form-check">
                                            ...
                                            <input class="form-check-input" type="radio" name="status" @if($booking->status == 'done' )  checked  @endif value="done"
                                            id="status4">
