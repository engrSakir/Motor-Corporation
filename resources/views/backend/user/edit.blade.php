...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <form action="{{ route('backend.user.update', $user) }}" method="POST" class="form-horizontal form-material"
                ...
                <div class="form-body">
                    <div class="card-body">
                        <div class="row pt-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-group has-danger">
                                    <label class="form-label" for="user_phone">Phone <b
                                            class="text-danger">*</b></label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="form-group">
                                        <label>Roles</label>
                                        <select class="form-control" multiple name="role[]" id="">
                                            <option>Choose A Role ..</option>
                                            @foreach($roles as $role)
                                            <option value="{{ $role->id }}" @if($user->hasRole($role->name)) selected
                                                @endif>{{
                                                $role->name }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group has-success">
                                    ...
                                    <textarea class="form-control" name="user_address"
                                        id="user_address">{{ $user->address }} </textarea>
                                    @error('user_address')
                                    <div class="alert alert-danger" role="alert">
                                        {{ $message }}
                                    </div>
