    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center text-end">
            <div class="d-flex justify-content-end align-items-center">
                ...
                <a href="{{ route('backend.investor.create') }}" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Create
                    New</a>
            </div>
        </div>
    </div>
                        ...
                        <tbody>
                            @foreach($investors as $investor)
                                <tr>
                                    ...
                                    <a  class="btn btn-danger btn-circle delete-btn" href="{{ route('backend.investor.show', $investor) }}">
