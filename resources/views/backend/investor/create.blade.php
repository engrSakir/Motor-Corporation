                            ...
                            <div class="row pt-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="any" id="initial_deposit" name="initial_deposit" class="form-control" placeholder="Initial Deposit" value="{{ old('initial_deposit') }}" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="any" id="current_amount" name="current_amount" class="form-control" placeholder="Current Amount" value="{{ old('current_amount') }}" required>
