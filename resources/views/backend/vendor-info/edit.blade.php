    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card-header bg-info">
                ...
                <div class="card-body">
                <form action="{{ route('backend.vendorInfo.update',$vendorInfo) }}" method="POST" class="form-horizontal form-material" enctype="multipart/form-data">
                    @csrf
                    @method('patch')
                    <div class="form-body">
                        <div class="card-body">
                            <div class="row pt-3">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label" for="name">Vendor  Name<b class="text-danger">*</b> </label>
                                        <input type="text" id="name" name="name" class="form-control" placeholder="Vendor Name" value="{{ $vendorInfo->name }}" required>
                                        @error('name')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="phone" name="phone" class="form-control" placeholder="Phone" value="{{ $vendorInfo->phone }}" required>
                                        @error('phone')
                                        <div class="alert alert-danger" role="alert">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" id="email" name="email" class="form-control" placeholder="Email" value="{{ $vendorInfo->email }}">
                                        @error('email')
                                        <div class="alert alert-danger" role="alert">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="address" name="address" class="form-control" placeholder="Address" value="{{ $vendorInfo->address }}">
                                        @error('address')
                                        <div class="alert alert-danger" role="alert">
                                            {{ $message }}
                                        </div>
