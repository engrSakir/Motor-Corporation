    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card-header bg-info">
                ...
                <div class="card-body">
                <form action="{{ route('backend.vendorInfo.store') }}" method="POST" class="form-horizontal form-material" enctype="multipart/form-data">
                    @csrf
                    <div class="form-body">
                        <div class="card-body">
                            <div class="row pt-3">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="name" name="name" class="form-control" placeholder="Vendor Name" value="{{ old('name') }}" required>
                                        @error('name')
