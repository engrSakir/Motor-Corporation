                            ...
                            <div class="row pt-3">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="select2 form-select form-control" id="vendor" name="vendor" required>
                                            ...
                                            <option value="{{ $vendor->id }}" @if(old('vendor') == $vendor->id) selected @endif>{{ $vendor->name }}</option>
                                            @endforeach
                                          </select>
                                          </select>
                                        @error('vendor')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="any" id="purchase_price" name="purchase_price" class="form-control" placeholder="Purchase price" value="{{ old('purchase_price') }}" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="any" id="selling_price" name="selling_price" class="form-control" placeholder="Selling price" value="{{ old('selling_price') }}" required>
                                        @error('selling_price')
                                        <div class="alert alert-danger" role="alert">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="any" id="vat_percentage" name="vat_percentage" class="form-control" placeholder="Vat percentage" value="{{ old('vat_percentage') }}" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="any" id="discount_percentage" name="discount_percentage" class="form-control" placeholder="Discount percentage" value="{{ old('discount_percentage') }}" required>
