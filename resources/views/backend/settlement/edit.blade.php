                            ...
                            <div class="row pt-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="select2 form-select form-control" id="investment" name="investment" required>
                                            ...
                                            <optgroup label="{{ $investor->name }}">
                                                ...
                                                <option value="{{ $investment->id }}" @if($settlement->investment == $investment) selected @endif>ID: {{ $investment->id }} Unsettlement: {{ $investment->investWithInterest() - $investment->settlements->sum('amount') }} Settlement: {{ $investment->settlements->sum('amount') }}</option>
                                                @endforeach
                                            </optgroup>
                                            @endforeach
                                          </select>
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        <input type="number" step="any" step="any" class="form-control" name="settlemen_amount" placeholder="Settlement amount" value="{{ $settlement->amount }}" required>
                                    </div>
