                ...
                <div class="row" style="font-size: 8px;">
                    <div class="col-md-12">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control form-control-sm" readonly value="{{ $selected_car->category->name ?? '#' }}">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control form-control-sm" readonly value="{{ $selected_car->name }}">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control form-control-sm" readonly value="{{ $selected_car->brand }}">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control form-control-sm" readonly value="{{ $selected_car->model }}">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control form-control-sm" readonly value="{{ $selected_car->registration }}">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control form-control-sm" readonly value="{{ $selected_car->mileages }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="input-group bg-warning">
                            ...
                            <input type="text" class="form-control form-control-sm" readonly value="{{ $selected_car->purchase_price }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control form-control-sm" readonly value="{{ $selected_car->selling_price }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="input-group">
                            ...
                            <div class="col-md-6">
                                <div class="input-group input-group-append">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="advance_for_booking" id="booking" value="1" wire:model="advance_for_booking">
                                    ...
                                    &nbsp;
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="advance_for_booking" id="sold" value="0" wire:model="advance_for_booking">
             ...
             <div>
              ...
              <form wire:submit.prevent="saveCustomer">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="full_name" wire:model="full_name" placeholder="Mr. Example">
                    @error('full_name')
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="email_address" wire:model="email_address" placeholder="name@example.com">
                    @error('email_address')
                        <div class="alert alert-danger" role="alert">
                            {{ $message }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="phone_number" wire:model="phone_number" placeholder="+880 123 ....">
                    @error('phone_number')
                        <div class="alert alert-danger" role="alert">
                            {{ $message }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="address" wire:model="address" placeholder="Example, Address">
                    @error('address')
                        <div class="alert alert-danger" role="alert">
                            {{ $message }}
                        </div>
