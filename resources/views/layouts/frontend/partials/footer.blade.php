                ...
                <div class="col-sm-4 col-xs-12" style="text-align: center;">
                    <div class="social">
                        <ul>
                            ...
                            <li class="instagram"><a href="https://www.instagram.com/motor_corporation/"
                                    target="_blank"></a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-4 col-xs-12 coppyright">&copy; Developed by <a href="https://iciclecorporation.com/"
                        target="_blank">Icicle Corporation</a>. </div>
            </div>
        </div>
    </div>
    <!-- BEGIN SIMPLE FOOTER -->
