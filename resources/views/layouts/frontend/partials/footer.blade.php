                    ...
                    <div class="footer-column">
                        ...
                        <ul class="links">
                            <li class="first"><a title="How to buy"
                                    href="http://themesground.com/blog/">Blog</a></li>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-4 col-xs-12" style="text-align: center;">
                    <div class="social">
                        <ul>
                            <li class="fb"><a href="https://www.facebook.com/MotorCorporationBD" target="_blank"></a></li>
                            <!-- <li class="tw"><a href="#"></a></li>
                            <li class="googleplus"><a href="#"></a></li>
                            <li class="rss"><a href="#"></a></li>
                            <li class="pintrest"><a href="#"></a></li>
                            <li class="linkedin"><a href="#"></a></li>-->
                            <li class="instagram"><a href="https://www.instagram.com/motor_corporation/" target="_blank"></a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-4 col-xs-12 coppyright">&copy; Developed by <a href="https://iciclecorporation.com/" target="_blank">Icicle Corporation</a>. </div>
            </div>
        </div>
    </div>
    <!-- BEGIN SIMPLE FOOTER -->
