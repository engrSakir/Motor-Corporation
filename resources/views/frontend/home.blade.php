...
<!--
			...
			* INTRO-SECTION
			************************************************************ -->
<div class="section ckav-section pd-0 flex-bl bg-cover bg-cc typo-light"
    data-bg="{{ asset('assets/frontend/images/6.jpg') }}" data-tsection="sdark">

    <!--=================================
= SLIDE SHOW
==================================-->
    <div class="full-wh nc-bgeffect">
        <div class="bgslider nc-bgeffect bg-cc bg-cover full-wh"
            data-bgslider="{{ asset('assets/frontend/images/6.jpg')}}|{{ asset('assets/frontend/images/5.jpg') }}">
        </div>
    </div>
    <!-- ======= END : SLIDE SHOW =======  -->
...
= CONTENT
==================================-->
    <div class="ckav-section--content z9 pd-80 animated s008" data-animIn="fadeInUp|0.0" data-animOut="fadeOutUp|0.0"
        data-ckav-sm="pd-40">

        <!-- INTRO-TEXT -->
        <div class="ckav-title">
            <h1 class="title f-3 italic bold-1 with-sep sep-right sep-light mr-b-0 animated s008"
                data-animIn="fadeInUp|0.1" data-ckav-sm="fs20">
                <!-- <span>Creative</span>-->
            </h1>
            <h1 class="title xxlarge f-1 bold-4 mr-b-0 animated s008" data-animIn="fadeInUp|0.2" data-ckav-md="fs60"
                data-ckav-sm="fs30">
                Motor Corporation
            </h1>
        </div><!-- INTRO-TEXT -->

        <a href="#subscribe-section" title="subscribe" data-tosection="subscribe-section"
            class="scroll-to small btn btn-default solid f-1 txt-upper bold-4 mr-t-30 animated s008"
    ...
    <div class="ckav-section--content container-fluid z9">
        <div class="row flex-eqh min-vh-h100">
            ...
            <div class="col-lg-7 flex-cc align-c" data-ckav-md="pd-60" data-ckav-sm="pd-40">
                <div class="inner-wrapper w60 mr-auto animated s008" data-animIn="fadeInUp|0.0"
                    data-animOut="fadeOutUp|0.0">
                    ...
                    <h2 class="title f-1 bold-1 small animated s008" data-animIn="fadeInUp|0.3">
                        We are an independent creative company specialise in web services. Effective design is mixture
                        of strategy & creativity that focus on requirement to achieve goals. We produce designs to
                        capture and engage audience with powerful digital experience.
                    </h2>
            ...
            <!-- RIGHT -->
            <div class="col-lg-5 flex-cc bg-cover bg-cc" data-ckav-sm="min-px-h300"
                data-bg="{{ asset('assets/frontend/images/3.jpg') }}">
    ...
    <div class="ckav-section--content container-fluid z9">
        <div class="row flex-eqh min-vh-h100">
            ...
            <div class="col-lg-7 flex-cc align-c pd-0" data-ckav-sm="min-px-h300">
                ...
                <!-- GOOGLE MAP -->
                <div class="gmap-widget w100 h100" data-map-latitude="-37.817136" data-map-longitude="144.955652"
            ...
            <div class="col-lg-5 typo-light flex-cl dark-bg" data-ckav-md="pd-60" data-ckav-sm="pd-40">
                <div class="inner-wrapper w60 pd-l-80 animated s008" data-animIn="fadeInUp|0.0"
                    data-animOut="fadeOutUp|0.0" data-ckav-md="pd-0" data-ckav-sm="pd-0">

                    <!-- TITLE -->
                    <div class="ckav-title mr-b-60 inline-block">
                        <h1 class="title small f-3 italic bold-1 with-sep sep-right sep-light mr-b-0 animated s008"
                            data-animIn="fadeInUp|0.1" data-ckav-sm="fs20">
                            <span>
                                Find location
                            </span>
                        </h1>
                        <h1 class="title f-1 bold-4 mr-b-0 animated s008" data-animIn="fadeInUp|0.2" data-ckav-md="fs60"
                            data-ckav-sm="fs30">Contact us</h1>
                    </div><!-- TITLE -->
                    ...
                    <!-- BUTTON -->
                    <a href="#" title="subscribe" data-popup="contact-form"
                        class="ckav-trigger small btn btn-default solid f-1 txt-upper bold-4 mr-t-30 animated s008"
...
<div class="section ckav-section pd-0 flex-cc" data-tsection="slight" data-bgcolor="rgba(0,0,0,0.2)">
    ...
    <!-- CONTENT -->
    <div class="ckav-section--content container z9 animated s008" data-animIn="fadeInUp|0.0"
        data-animOut="fadeOutUp|0.0" data-ckav-md="pd-60" data-ckav-sm="pd-40">
        <div class="row">
            <div class="col-md-12 align-c">
                ...
                <div class="ckav-title align-c">
                    ...
                    <p class="f-2 px-w500 mr-auto animated s008" data-animIn="fadeInUp|0.3" data-ckav-sm="w100">
                        Subscribe for our newsletter and get the latest updates. Be the first one to know about the
                        special offers and latest news.
                    </p>
                </div><!-- / TITLE -->

                <!-- FORM -->
                <div class="subscribe-block _1 block mr-b-20 mr-t-mini mr-auto px-w500 animated s008"
                    data-ckav-sm="subscribe-reset w100" data-animIn="fadeInUp|0.3" data-ckav-md="w100">
                    <form action="http://pinak.c-kav.com/demos/form-data/notify-me.php" class="form-widget"
                        data-formtype="newsletter" novalidate="novalidate">
                        <div class="form-group">
                            <input class="form-control w100" data-label="Email" data-msg="Please enter email."
                                type="email" name="email" placeholder="Enter your email">
                            <button type="submit" data-loading-text="Pleae wait.."
                                class="btn btn-dark hov-btn-default solid"><i class="far fa-envelope fs26"></i></button>
                        </div>
                    </form>
                </div><!-- / FORM -->
...
<div class="section ckav-section pd-0 flex-cc dark-bg" data-tsection="sdark">
    ...
    <div class="ckav-section--content container z9 animated s008" data-animIn="fadeInUp|0.0"
        ...
        <div class="row">
            <div class="col-md-12 align-c">
                <a href="#" target="_blank" class="sq120 fs30 mr-20 rd-4 iconbox btn-white animated s008"
        ...
        <p class="mr-t-30 align-c txt-white op-07 fs12">copyright <i class="far fa-copyright"></i> C.Kav.Art <span
...
<div id="contact-form" class="ckav-popup ckav-popup-effect1 flex-cc">
    <div class="ckav-popup-content bg-white ckav-scrollbar pd-80 px-w700" data-ckav-md="pd-60"
        ...
        <div class="inner-wrapper w100">
            ...
            <div class="ckav-popup--body align-c mr-t-60" data-ckav-md="mr-t-60" data-ckav-sm="mr-t-40">
                ...
                <form action="http://pinak.c-kav.com/demos/form-data/formdata.php" class="form-widget"
                    ...
                    <div class="field-wrp">
                        ...
                        <div class="form-group">
                            <input class="form-control" data-label="Subject" required=""
                                data-msg="Please enter subject." type="text" name="subject" placeholder="Enter subject"
                                aria-required="true">
                        </div>
                        <div class="form-group">
